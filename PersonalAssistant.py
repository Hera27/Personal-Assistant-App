class PersonalAssistant:
    ...
    def add_birthday(self, name, date):
      if name in self.birthdays:
          return f"you already have birthday for {name}"
      else:
    ...
    def remove_birthday(self, name):
      if name in self.birthdays:
        ...
        return "Sorry, there is no birthday listed for that person."
    ...
    def add_contact(self,name, job_position):
      if name in self.contacts:
        return f"{name}'s contact info is already listed."
      else:
          self.contacts [name] = job_position
          return f"{name}'s contact info has been added."

    def remove_contact(self, name):
      if name in self.contacts:
          self.contacts.pop(name)
          return f"{name}'s contact info has been removed."
      else:
        return "Sorry there is no contact info listed for that person."
